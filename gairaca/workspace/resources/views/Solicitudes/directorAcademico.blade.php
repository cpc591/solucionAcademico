...
@section('app','ng-app="appDirectorAcademico"')
@section('controller','ng-controller="listado_solicitudes_directorAcademicoCtrl"')
            ...
            <div>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      <li role="presentation" class="active"><a href="#lista" aria-controls="lista" role="tab" data-toggle="tab">Solicitudes por aprobar</a></li>
                      <li role="respondidas" ><a href="#respondidas" aria-controls="respondidas" role="tab" data-toggle="tab">Solicitudes aprobadas</a></li>
                    </ul>
                  </div>
                </div>
              <!-- Tab panes -->
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="lista" style="padding:30px">
                    ...
                    <br>
                    <div class="text-center" ng-if="(listado_solicitudes_directorAcademico | filter:search).length > 0 ">
                        <p>Hay @{{(listado_solicitudes_directorAcademico | filter:search).length}} registro(s) que coinciden con su búsqueda</p>
                    </div>
                    <div class="alert alert-info" ng-if="listado_solicitudes_directorAcademico.length == 0">
                        <p>No hay registros almacenados</p>
                    </div>
                    <div class="alert alert-warning" ng-if="(listado_solicitudes_directorAcademico | filter:search).length == 0 && listado_solicitudes_directorAcademico.length > 0">
                        <p>No existen registros que coincidan con su búsqueda</p>
                    </div>
                    <div class="alert alert-info" role="alert"  ng-show="mostrarFiltro == false && (search.asunto_nuevo.nombre.length > 0 || search.accion_nombre.length > 0 || search.created_at.length > 0 || search.duracion.length > 0 || search.fechaEstimada.length > 0 || search.estudiante.nombre.length > 0 || search.estudiante.codigo.length > 0 || search.consecutivo.length > 0 )">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr dir-paginate="x in listado_solicitudes_directorAcademico | filter:search | itemsPerPage:10" pagination-id="paginacion_solicitudes" ng-class="{'danger':(x.alertaDuracion<=3  && x.alertaDuracion>=0) || x.alertaDuracion<0 && x.accion_id!=7 && x.accion_id!=2, 'warning':x.alertaDuracion<=6 && x.alertaDuracion>=4 && x.accion_id!=7 && x.accion_id!=2,'success':x.alertaDuracion>6 && x.accion_id!=7 && x.accion_id!=2}">
                            <td>@{{x.consecutivo}}</td>
                            <td>
                            ...
                            <td>
                              <div class="dropdown"  style="float:left">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li><a href="/ver_mas_academico/@{{x.id}}">Ver más</a></li>
                                  <li ng-if="(x.accion_id==4) && x.acciones[0].user_id=={{Auth::user()->id}}"><a href="" ng-click="crear_novedad_modal(x.id)">Novedad </a></li>
                                  <li ng-if="(x.accion_id==4) && x.acciones[0].user_id=={{Auth::user()->id}}"><a href="" ng-click="crear_solicitudConcepto_modal(x.id)">Solicitud de concepto</a></li>
                                </ul>
                              </div>
                              <a ng-if="x.accion_id==8" href="/aprobar_directorAcademico/@{{x.id}}" class="btn btn-default" title="Aprobar solicitud" style="float:left"><span class="glyphicon glyphicon-ok texto_verde"></span></a>
                            </td>
                        </tr>
                      </tbody>  
                ...
                <div role="tabpanel" class="tab-pane " id="respondidas" style="padding:30px">
                    ...
                    <div class="flex-list" style="text-align:center;">
                        <div class="form-group has-feedback" style="display: inline-block;">
                            <button type="button" ng-click="mostrarFiltroRespondida=!mostrarFiltroRespondida" class="btn btn-lg btn-default" title="filtrar registros"><span class="glyphicon glyphicon-filter"></span><span class="sr-only">Filtros</span></button>
                        </div>      
                    </div>
                    <br>
                    ...
                    <div class="alert alert-info" role="alert"  ng-show="mostrarFiltroRespondida == false && (searchRespondidas.asunto_nuevo.nombre.length > 0 || searchRespondidas.accion_nombre.length > 0 || searchRespondidas.created_at.length > 0 || searchRespondidas.duracion.length > 0 || searchRespondidas.fechaEstimada.length > 0 || searchRespondidas.estudiante.nombre.length > 0 || searchRespondidas.estudiante.codigo.length > 0 )">
                    ...
                    <table class="table table-hover">
                        <thead>
                          ...
                          <tr ng-show="mostrarFiltroRespondida == true">
                              <td><input type="text" ng-model="searchRespondidas.consecutivo" name="consecutivo" id="consecutivo" class="form-control input-sm" id="inputSearch" maxlength="150" autocomplete="off"></td>
                              ...
                              <td><input type="text" ng-model="searchRespondidas.respuesta.radicadoRespuesta" name="radicadoRespuesta" id="radicadoRespuesta" class="form-control input-sm" maxlength="150" autocomplete="off"></td>
                              @if(Auth::user()->id == 39)
                        ...
                        <tbody>
                          <tr dir-paginate="x in respondidas_dependencias |filter:searchRespondidas | itemsPerPage:10" pagination-id="paginacion_respondidas" >
                              ...
                              <td>@{{x.estudiante.nombre}}</td>
                              <td>@{{x.estudiante.codigo}}</td>
                              <td>@{{x.respuesta.radicadoRespuesta}}</td>
                              @if(Auth::user()->id == 39)
                                <td >@{{x.encargado == null ? '-' : x.encargado}}</td>
                              @endif
                              <td>
                                <div class="dropdown"  style="float:left">
                                  ...
                                  <ul class="dropdown-menu">
                                    ...
                                    <li><a href="/ver_mas_academico/@{{x.id}}">Ver más</a></li>
                                    <li><a target="_blank" href="/pdfRespuesta/@{{x.id}}">Ver respuesta</a></li>
                                  </ul>
                                </div>
                ...
                <div role="tabpanel" class="tab-pane " id="novedades" style="padding:30px">
                    ...
                    <table class="table table-hover table-striped">
                        <tr>
                            <th style="width:400px;">Solicitud</th>
                ...
                <div role="tabpanel" class="tab-pane " id="listaSolicitudConcepto" style="padding:30px">
                  
                    <br>
                    <div class="row">
                      <div class="col-md-4 col-md-offset-6">
                        <input type="text" style="margin-top:15px;" class="form-control" placeholder="Buscar" ng-model="buscarSolicitudConcepto">
                      </div>
                      <div class="alert alert-info col-md-2 pull-right cant_tabla">
...
@section('javascript')
    ...
    <script src="{{asset('/js/plugins/material.min.js')}}"></script>
  	...
  	<script src="{{asset('/js/directorAcademico/directorAcademico.js')}}"></script>
    <script src="{{asset('/js/directorAcademico/directorAcademicoServices.js')}}"></script>
@endsection
