...
@section('contenido')
    ...
    <div class="container" style="padding-top:30px" ng-controller="loginCtrl" ng-app="myApp">
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12" id="login">
                            ...
                            <form class="form-horizontal"  action="/loginestudiante" method="POST" >
                              ...
                              <div class="form-group row col-sm-12 col-xs-12" >
                                  ...
                                  <input type="text" name="codigo" class="form-control" id="inputEmail3" placeholder="Código">
