...
@section('controller','ng-controller="responderCtrl"')
...
@section('contenido')
    <div class="container" style="padding-left:70px;padding-right:70px;">
            ...
            <input type="hidden" ng-model="idSolicitud" ng-init="idSolicitud={{$id}}" /> 
            <div>
                <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="col-md-6">
                    <div class="row">
                            <div class="col-md-12 col-xs-12 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" ng-model="solicitud.tipos.nombre" readonly/>
                                    <input type="hidden" ng-model="respuesta.solicitud" ng-init="respuesta.solicitud={{$id}}"/>
                            </div>
                    ...
                    <div class="row">
                            <div class="col-md-12  col-xs-12 col-sm-12">
                                ...
                                <input type="text" ng-model="solicitud.asunto" name="Asunto" class="form-control" ng-required="true" readonly />
                    ...
                    <form role="form" name="formCrear"  novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-xs-12 col-sm-12">
                                ...
                                <input type="text" ng-model="user.nombre"  class="form-control" ng-required="true" readonly />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-xs-12 col-sm-12">
                                ...
                                <input type="text" name="Identificacion" class="form-control" ng-model="datos.estudiante.NUMDOC" ng-required="true" readonly />
                            </div>
                            <div class="col-md-5 col-xs-12 col-sm-12">
                                <label><span class="asterisco">*</span>Correo</label>
                                <input type="text" name="Correo" class="form-control" ng-model="user.email" ng-required="true" readonly />
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="list-group"  ng-if="multimedias.length >0">
            ...
            <div class="row">
                ...
                <form role="form" name="formRespuesta"  novalidate>
                        ...
                        <!--
                        <div class="col-xs-12" ng-if="respuesta!=null">
                    ...
                    <div class="col-xs-12">
                        <br>
                        <div class="list-group"  ng-if="multimedias_respuesta.length >0">
                    ...
                    <div class="col-md-12">
                        <div class="row" style="text-align:center;padding:50px;">
                           <div class="col-xs-12 col-sm-4 col-md-4">
                               <button type="button" class="btn btn-success" ng-click="crear_respuesta(respuesta)">
                                     Responder
                                </button>
                           </div>
                           <div class="col-xs-12 col-sm-4 col-md-4">
                               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#reenviar">
                                     Reenviar
                                </button>
                           </div>
                           <div class="col-xs-12 col-sm-4 col-md-4">
                               <button type="button" class="btn btn-primary"  ng-click="crear_borrador(respuesta)">
                                     Borrador
                                </button>
                           </div>    
              ...
              <div class="modal-body">
                  <div class="row">
                        <div class="col-md-6 col-xs-12 col-sm-6">
                                ...
                                <input type="hidden" ng-model="reenviar.solicitude_id" ng-init="reenviar.solicitude_id=idSolicitud"/>
